...
namespace SMDH.Models.Utilities
{
    ...
    {
        public static void UpdateMapLocation(SMDHDataContext context, Order order)
        {
            UpdateMapLocation(context, order, true);
        }

        public static void UpdateMapLocation(SMDHDataContext context, Order order, bool commit)
        {
            try
            {
        ...
        public static void UpdateMapLocation(SMDHDataContext context, CustomerAddress hub, bool commit)
        {
            try
            {
                var geocodingRequest = new GeocodingRequest();
        ...
        public static void UpdateMapLocation(SMDHDataContext context, Hub hub, bool commit)
        {
            try
            {
                var geocodingRequest = new GeocodingRequest();
