...
namespace HDMS.Models.mTsp
{
    public static class MTspHelper
    {
        private static HDMSEntities context = new HDMSEntities();
        ...
        public  static void initialize()
        {
            ...
            Stream data_stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(@"HDMS.Models.mTsp.HoChiMinh.osm");
